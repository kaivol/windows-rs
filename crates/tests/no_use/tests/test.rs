...
use windows::core::ComObjectImplExt;
...
impl windows::Foundation::IStringable_Impl for Test {
    fn ToString(this: &Self::This) -> windows::core::Result<windows::core::HSTRING> {
        Ok(this.0.into())
    }
}

impl windows::Foundation::IClosable_Impl for Test {
    fn Close(_this: &Self::This) -> windows::core::Result<()> {
        Ok(())
    }
}
...
fn test() -> windows::core::Result<()> {
    let a: windows::Foundation::IStringable = Test("test").into_interface();
